...
public class RangeParse {
    public static final String[][] RANGE_PARSE = {
            {"1.0.0 - 2.0.0", ">=1.0.0 <=2.0.0"},
            // {"1.0.0 - 2.0.0", ">=1.0.0-0 <2.0.1-0"}, // includePrerelease
            {"1 - 2", ">=1.0.0 <3.0.0-0"},
            // {"1 - 2", ">=1.0.0-0 <3.0.0-0"}, // includePrerelease
            {"1.0 - 2.0", ">=1.0.0 <2.1.0-0"},
            // {"1.0 - 2.0", ">=1.0.0-0 <2.1.0-0"}, // includePrerelease
            {"1.0.0", "1.0.0"},
            {">=*", "*"},
            {"", "*"},
            {"*", "*"},
            ...
            {"< 1.2", "<1.2.0-0"},
            {"1", ">=1.0.0 <2.0.0-0"},
            // {">01.02.03", ">1.2.3"}, // loose
            {">01.02.03", null},
            // {"~1.2.3beta", ">=1.2.3-beta <1.3.0-0"}, // loose
            {"~1.2.3beta", null},
